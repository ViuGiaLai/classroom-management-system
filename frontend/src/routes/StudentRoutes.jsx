...
import StudentClasses from '../pages/student/Class/index';
import TaiLieu from '../pages/student/TaiLieu/index';
...
const StudentRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="classes/:classId" element={<div className="p-6">Chi tiết lớp học (coming soon)</div>} />
      <Route path="courses" element={<div className="p-6">Khóa học (coming soon)</div>} />
      <Route path="materials" element={<TaiLieu />} />
