      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md transform transition-all">
        ...
        <div className="p-6">
          <p className="text-slate-700 mb-4">
            ...
            <strong className="text-slate-900">{userToDelete.full_name}</strong>?
          </p>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={submitLoading}
              className="flex-1 px-4 py-2.5 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all disabled:opacity-50"
            >
