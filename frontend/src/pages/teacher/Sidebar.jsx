...
const navItems = [
  ...
  { key: "users", path: "/teacher/users", label: "Người dùng", icon: UserOutlined },
  { key: "students", path: "/teacher/students", label: "Sinh viên", icon: TeamOutlined },
  { key: "lecturers", path: "/teacher/lecturers", label: "Giảng viên", icon: SolutionOutlined },
  { key: "departments", path: "/teacher/departments", label: "Khoa", icon: ApartmentOutlined },
  { key: "majors", path: "/teacher/majors", label: "Chuyên ngành", icon: ReadOutlined },
  { key: "courses", path: "/teacher/courses", label: "Học phần", icon: BookOutlined },
  { key: "classes", path: "/teacher/classes", label: "Lớp học phần", icon: ScheduleOutlined },
  ...
  { key: "settings", path: "/teacher/settings", label: "Cài đặt", icon: SettingOutlined },
  { key: "logs", path: "/teacher/logs", label: "Nhật ký", icon: HistoryOutlined },
];
