...
See https://s-c.sh/2BAXzed for more info.`),window[lu]+=1);const TS="Document {{ currentFileNo }} of {{ allFilesCount }}",PS="No renderer for file type: {{{ fileType }}}",RS="Download file",LS="Your file is broken. Please check it on your machine.",kS="Recipients",IS="Sender",FS="Loading...",MS="Page {{ currentPage }}/{{ allPagesCount }}",DS={documentNavInfo:TS,noRendererMessage:PS,downloadButtonLabel:RS,brokenFile:LS,msgPluginRecipients:kS,msgPluginSender:IS,pdfPluginLoading:FS,pdfPluginPageNumber:MS},OS="Dokument {{ currentFileNo }} z {{ allFilesCount }}",NS="Brak funckji renderującej dla: {{{ fileType }}}",BS="Pobierz plik",$S="Twój plik jest uszkodzony. Sprawdź go na swoim komputerze.",jS="Odbiorcy",US="Nadawca",HS="Wczytywanie...",zS="Strona {{ currentPage }}/{{ allPagesCount }}",GS={documentNavInfo:OS,noRendererMessage:NS,downloadButtonLabel:BS,brokenFile:$S,msgPluginRecipients:jS,msgPluginSender:US,pdfPluginLoading:HS,pdfPluginPageNumber:zS},VS="Documento {{ currentFileNo }} de {{ allFilesCount }}",WS="No hay procesador para el tipo de archivo: {{{ fileType }}}",qS="Descargar archivo",XS="Tu archivo está roto. Compruébalo en tu máquina.",YS="Destinatarios",KS="Remitente",ZS="Cargando...",JS="Página {{ currentPage }}/{{ allPagesCount }}",QS={documentNavInfo:VS,noRendererMessage:WS,downloadButtonLabel:qS,brokenFile:XS,msgPluginRecipients:YS,msgPluginSender:KS,pdfPluginLoading:ZS,pdfPluginPageNumber:JS},tC="Dokument {{ currentFileNo }} von {{ allFilesCount }}",eC="Kein Renderer für Dateityp: {{{ fileType }}}",nC="Datei herunterladen",iC="Ihre Datei ist defekt. Bitte überprüfen Sie sie auf Ihrem Rechner.",sC="Empfänger",rC="Absender",oC="Wird geladen...",aC="Seite {{ currentPage }}/{{ allPagesCount }}",lC={documentNavInfo:tC,noRendererMessage:eC,downloadButtonLabel:nC,brokenFile:iC,msgPluginRecipients:sC,msgPluginSender:rC,pdfPluginLoading:oC,pdfPluginPageNumber:aC},cC="Documento {{ currentFileNo }} di {{ allFilesCount }}",hC="Nessun renderer per il tipo di file: {{{ fileType }}}",uC="Scarica file",dC="Il tuo file è danneggiato. Controllalo sul tuo computer.",fC="Destinatari",pC="Mittente",gC="Caricamento in corso...",mC="Pagina {{ currentPage }}/{{ allPagesCount }}",vC={documentNavInfo:cC,noRendererMessage:hC,downloadButtonLabel:uC,brokenFile:dC,msgPluginRecipients:fC,msgPluginSender:pC,pdfPluginLoading:gC,pdfPluginPageNumber:mC},yC="Documento {{ currentFileNo }} de {{ allFilesCount }}",bC="Nenhum renderizador para o tipo de arquivo: {{{ fileType }}}",wC="Baixar arquivo",AC="Seu arquivo está quebrado. Por favor, verifique-o em sua máquina.",EC="Destinatários",_C="Remetente",xC="Carregando...",SC="Página {{ currentPage }}/{{ allPagesCount }}",CC={documentNavInfo:yC,noRendererMessage:bC,downloadButtonLabel:wC,brokenFile:AC,msgPluginRecipients:EC,msgPluginSender:_C,pdfPluginLoading:xC,pdfPluginPageNumber:SC},TC="Document {{ currentFileNo }} de {{ allFilesCount }}",PC="Aucun moteur de rendu pour le type de fichier : {{{ fileType }}}",RC="Télécharger le fichier",LC="Votre fichier est cassé. Veuillez le vérifier sur votre machine.",kC="Destinataires",IC="Expéditeur",FC="Chargement...",MC="Page {{ currentPage }}/{{ allPagesCount }}",DC={documentNavInfo:TC,noRendererMessage:PC,downloadButtonLabel:RC,brokenFile:LC,msgPluginRecipients:kC,msgPluginSender:IC,pdfPluginLoading:FC,pdfPluginPageNumber:MC},OC="مستند {{ currentFileNo }} من {{ allFilesCount }}",NC="{{{ fileType }}} : لا يمكننا عرض هذا النوع من الملفات",BC="تحميل الملف",$C="الملف تالف، يرجى التحقق منه على جهازك الخاص.",jC="المستلمين",UC="المرسل",HC="تحميل ...",zC=" {{ allPagesCount }} \\ {{ currentPage }} صفحة ",GC={documentNavInfo:OC,noRendererMessage:NC,downloadButtonLabel:BC,brokenFile:$C,msgPluginRecipients:jC,msgPluginSender:UC,pdfPluginLoading:HC,pdfPluginPageNumber:zC},VC="Dokument {{ currentFileNo }} od {{ allFilesCount }}",WC="Ne postoji pregledač za tip fajla: {{ fileType }}",qC="Preuzimanje fajla",XC="Vaš fajl nije dobar. Molimo Vas da probate da ga otvorite na vašem računaru.",YC="Primaoci",KC="Pošiljalac",ZC="Učitavanje...",JC="Strana {{ currentPage }}/{{ allPagesCount }}",QC={documentNavInfo:VC,noRendererMessage:WC,downloadButtonLabel:qC,brokenFile:XC,msgPluginRecipients:YC,msgPluginSender:KC,pdfPluginLoading:ZC,pdfPluginPageNumber:JC},tT="Документ {{ currentFileNo }} od {{ allFilesCount }}",eT="Не постоји прегледач за тип фајла: {{ fileType }}",nT="Преузимање фајла",iT="Ваш фајл није добар. Молимо Вас да пробате да га отворите на вашем рачунару.",sT="Примаоци",rT="Пошиљалац",oT="Учитавање...",aT="Страна {{ currentPage }}/{{ allPagesCount }}",lT={documentNavInfo:tT,noRendererMessage:eT,downloadButtonLabel:nT,brokenFile:iT,msgPluginRecipients:sT,msgPluginSender:rT,pdfPluginLoading:oT,pdfPluginPageNumber:aT},cT="ファイル {{ currentFileNo }} / {{ allFilesCount }}",hT="ファイルタイプに対応したレンダラーはありません: {{ fileType }}",uT="ダウンロード",dT="ファイルが壊れています。あなたのマシンでファイルを確認してください。",fT="受信者",pT="送信者",gT="ローティング中...",mT="ページ {{ currentPage }}/{{ allPagesCount }}",vT={documentNavInfo:cT,noRendererMessage:hT,downloadButtonLabel:uT,brokenFile:dT,msgPluginRecipients:fT,msgPluginSender:pT,pdfPluginLoading:gT,pdfPluginPageNumber:mT},yT="Документ {{ currentFileNo }} из {{ allFilesCount }}",bT="Данный тип файла не поддерживается рендером: {{{ fileType }}}",wT="Скачать файл",AT="Ваш файл сломан. Пожалуйста, проверьте его на своём комьютере.",ET="Получатели",_T="Отправитель",xT="Загрузка...",ST="Страница {{ currentPage }}/{{ allPagesCount }}",CT={documentNavInfo:yT,noRendererMessage:bT,downloadButtonLabel:wT,brokenFile:AT,msgPluginRecipients:ET,msgPluginSender:_T,pdfPluginLoading:xT,pdfPluginPageNumber:ST},TT="Dokument {{ currentFileNo }} av {{ allFilesCount }}",PT="Ingen renderare för filtypen: {{{ fileType }}}",RT="Ladda ner",LT="Filen är trasig. Var vänlig kontrollera den på din maskin.",kT="Mottagare",IT="Avsändare",FT="Laddar...",MT="Sida {{ currentPage }}/{{ allPagesCount }}",DT={documentNavInfo:TT,noRendererMessage:PT,downloadButtonLabel:RT,brokenFile:LT,msgPluginRecipients:kT,msgPluginSender:IT,pdfPluginLoading:FT,pdfPluginPageNumber:MT},OT="Belge {{ currentFileNo }} / {{ allFilesCount }}",NT="Dosya türü için görüntüleyici bulunamadı: {{{ fileType }}}",BT="Dosyayı indir",$T="Dosyanız bozuk. Lütfen kendi cihazınızda kontrol edin.",jT="Alıcılar",UT="Gönderen",HT="Yükleniyor...",zT="Sayfa {{ currentPage }}/{{ allPagesCount }}",GT={documentNavInfo:OT,noRendererMessage:NT,downloadButtonLabel:BT,brokenFile:$T,msgPluginRecipients:jT,msgPluginSender:UT,pdfPluginLoading:HT,pdfPluginPageNumber:zT},Qu={en:DS,pl:GS,es:QS,de:lC,it:vC,pt:CC,fr:DC,ar:GC,sr:QC,sr_cyr:lT,ja:vT,ru:CT,se:DT,tr:GT},VT=Object.keys(Qu),e0="en",Xy="SET_ALL_DOCUMENTS",Yy="SET_DOCUMENT_LOADING",Ky="NEXT_DOCUMENT",Zy="PREVIOUS_DOCUMENT",Jy="UPDATE_CURRENT_DOCUMENT",Qy="SET_RENDERER_RECT",tb="SET_MAIN_CONFIG",WT=(s,t)=>({type:Xy,documents:s,initialActiveDocument:t}),Vp=s=>({type:Yy,value:s}),n0=()=>({type:Ky}),i0=()=>({type:Zy}),wg=s=>({type:Jy,document:s}),qT=s=>({type:Qy,rect:s}),XT=s=>({type:tb,config:s}),td={currentFileNo:0,documents:[],documentLoading:!0,currentDocument:void 0,rendererRect:void 0,config:{},pluginRenderers:[],language:e0},YT=(s=td,t)=>{switch(t.type){case Xy:{const{documents:e,initialActiveDocument:n}=t;return{...s,documents:e,currentDocument:n||e[0]||null,currentFileNo:n&&e.includes(n)?e.indexOf(n):td.currentFileNo}}case Yy:{const{value:e}=t;return{...s,documentLoading:e}}case Ky:{if(s.currentFileNo>=s.documents.length-1)return s;const e=s.currentFileNo+1;return s.onDocumentChange&&s.onDocumentChange(s.documents[e]),{...s,currentFileNo:e,currentDocument:s.documents[e],documentLoading:!0}}case Zy:{if(s.currentFileNo<=0)return s;const e=s.currentFileNo-1;return s.onDocumentChange&&s.onDocumentChange(s.documents[e]),{...s,currentFileNo:s.currentFileNo-1,currentDocument:s.documents[e],documentLoading:!0}}case Jy:{const{document:e}=t;return{...s,currentDocument:e,currentFileNo:s.documents.findIndex(n=>n.uri===e.uri)}}case Qy:{const{rect:e}=t;return{...s,rendererRect:e}}case tb:{const{config:e}=t;return{...s,config:e}}default:return s}},xs=U.createContext({state:td,dispatch:()=>null}),KT=U.forwardRef((s,t)=>{const{children:e,documents:n,config:i,pluginRenderers:r,prefetchMethod:o,requestHeaders:l,initialActiveDocument:c,language:u,activeDocument:h,onDocumentChange:f}=s,[g,v]=U.useReducer(YT,{...td,documents:n||[],currentDocument:n&&n.length?c||n[0]:void 0,config:i,pluginRenderers:r,prefetchMethod:o,requestHeaders:l,currentFileNo:c?n.findIndex(y=>y===c)??0:0,language:u&&Qu[u]?u:e0,activeDocument:h,onDocumentChange:f});return U.useEffect(()=>{v(WT(n,c)),i&&v(XT(i))},[n,i,c]),U.useEffect(()=>{h&&v(wg(h))},[h]),U.useImperativeHandle(t,()=>({prev(){v(i0())},next(){v(n0())}}),[v]),O.jsx(xs.Provider,{value:{state:g,dispatch:v},children:e})}),ZT=Qf`
...
`,sb=(s,t)=>{var n;if(!s)return"";let e="";if(s.fileName)e=s.fileName;else{e=s.uri||"",e=decodeURI(e),t||(e=(n=e==null?void 0:e.split("?"))==null?void 0:n[0]);const i=e==null?void 0:e.split("/");i.length&&(e=i[i.length-1])}return e},EP=()=>{var n,i;const{state:{config:s,currentDocument:t}}=U.useContext(xs);if(!t||(n=s==null?void 0:s.header)!=null&&n.disableFileName)return null;const e=sb(t,((i=s==null?void 0:s.header)==null?void 0:i.retainURLParams)||!1);return O.jsx(_P,{id:"file-name","data-testid":"file-name",children:e})},_P=bt.div`
  ...
  margin: 0 10px;
  overflow: hidden;
`,xP=()=>{var i,r,o;const{state:s,dispatch:t}=U.useContext(xs),{config:e}=s;if((i=e==null?void 0:e.header)!=null&&i.disableHeader)return null;const n=(o=(r=e==null?void 0:e.header)==null?void 0:r.overrideComponent)==null?void 0:o.call(r,s,()=>t(i0()),()=>t(n0()));return n||O.jsxs(SP,{id:"header-bar","data-testid":"header-bar",children:[O.jsx(EP,{}),O.jsx(bP,{})]})},SP=bt.div`
  display: flex;
  justify-content: flex-end;
  align-items: center;
  z-index: 1;
...
`,ep=({documentURI:s,signal:t,fileLoaderComplete:e,readerTypeFunction:n,headers:i})=>fetch(s,{signal:t,headers:i}).then(async r=>{const o=await r.blob(),l=new FileReader;switch(l.addEventListener("loadend",()=>e(l)),n){case"arrayBuffer":l.readAsArrayBuffer(o);break;case"binaryString":l.readAsBinaryString(o);break;case"dataURL":l.readAsDataURL(o);break;case"text":l.readAsText(o);break}}).catch(r=>r),rb=s=>ep({...s,readerTypeFunction:"arrayBuffer"}),r0=s=>ep({...s,readerTypeFunction:"dataURL"}),o0=s=>ep({...s,readerTypeFunction:"text"}),CP=s=>ep({...s,readerTypeFunction:"binaryString"}),ob=r0,TP=()=>{const{state:{currentDocument:s,pluginRenderers:t}}=U.useContext(xs),[e,n]=U.useState();return U.useEffect(()=>{if(!s)return;if(!s.fileType){n(void 0);return}const i=[];t==null||t.forEach(o=>{s.fileType!==void 0&&o.fileTypes.indexOf(s.fileType)>=0&&i.push(o)});const[r]=i.sort((o,l)=>l.weight-o.weight);n(r&&r!==void 0?()=>r:null)},[s,t]),{CurrentRenderer:e}},PP=()=>{const{state:s,dispatch:t}=U.useContext(xs),{currentFileNo:e,currentDocument:n,prefetchMethod:i}=s,{CurrentRenderer:r}=TP(),o=(n==null?void 0:n.uri)||"";return U.useEffect(()=>{if(!n||n.fileType!==void 0)return;const l=new AbortController,{signal:c}=l;return fetch(o,{method:i||o.startsWith("blob:")?"GET":"HEAD",signal:c,headers:s==null?void 0:s.requestHeaders}).then(u=>{const h=u.headers.get("content-type"),f=(h==null?void 0:h.split(";"))||[],g=f.length?f[0]:void 0;t(wg({...n,fileType:g||void 0}))}).catch(u=>{if((u==null?void 0:u.name)!=="AbortError")throw u}),()=>{l.abort()}},[e,o,n]),U.useEffect(()=>{var f;if(!n||r===void 0)return;const l=new AbortController,{signal:c}=l,h={documentURI:o,signal:c,fileLoaderComplete:g=>{if(!n||!g){t(Vp(!1));return}const v={...n};g.result!==null&&(v.fileData=g.result),t(wg(v)),t(Vp(!1))},headers:s==null?void 0:s.requestHeaders};return r===null?t(Vp(!1)):r.fileLoader!==void 0?(f=r.fileLoader)==null||f.call(r,h):ob(h),()=>{l.abort()}},[r,e]),{state:s,dispatch:t,CurrentRenderer:r}},RP=()=>{const[s,t]=U.useState({width:void 0,height:void 0});return U.useEffect(()=>{function e(){t({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)},[]),s},lv=({children:s})=>{var r,o;const{state:t}=U.useContext(xs),{config:e}=t,[n,i]=U.useState(((r=e==null?void 0:e.loadingRenderer)==null?void 0:r.showLoadingTimeout)===!1);return U.useEffect(()=>{var l;setTimeout(()=>{i(!0)},typeof((l=e==null?void 0:e.loadingRenderer)==null?void 0:l.showLoadingTimeout)=="number"?e.loadingRenderer.showLoadingTimeout:500)},[(o=e==null?void 0:e.loadingRenderer)==null?void 0:o.showLoadingTimeout]),n?O.jsx(O.Fragment,{children:s}):null},LP=({documents:s,documentLoading:t,config:e,currentDocument:n,fileName:i,CurrentRenderer:r,state:o,t:l})=>{var c,u;if(s.length)if(t){if(e&&((c=e==null?void 0:e.loadingRenderer)!=null&&c.overrideComponent)){const h=e.loadingRenderer.overrideComponent;return O.jsx(lv,{children:O.jsx(h,{document:n,fileName:i})})}return O.jsx(lv,{children:O.jsx(IP,{id:"loading-renderer","data-testid":"loading-renderer",children:O.jsx(MP,{children:O.jsx(nP,{color:"#444",size:40})})})})}else{if(r)return O.jsx(r,{mainState:o});if(r===void 0)return null;if(e&&((u=e==null?void 0:e.noRenderer)!=null&&u.overrideComponent)){const h=e.noRenderer.overrideComponent;return O.jsx(h,{document:n,fileName:i})}return O.jsxs("div",{id:"no-renderer","data-testid":"no-renderer",children:[l("noRendererMessage",{fileType:(n==null?void 0:n.fileType)??""}),O.jsx(DP,{id:"no-renderer-download",href:n==null?void 0:n.uri,download:n==null?void 0:n.uri,children:l("downloadButtonLabel")})]})}else return O.jsx("div",{id:"no-documents"})},kP=()=>{var f;const{state:s,dispatch:t,CurrentRenderer:e}=PP(),{documents:n,documentLoading:i,currentDocument:r,config:o}=s,l=RP(),{t:c}=eo(),u=U.useCallback(g=>{g&&t(qT(g==null?void 0:g.getBoundingClientRect()))},[l,t]),h=sb(r,((f=o==null?void 0:o.header)==null?void 0:f.retainURLParams)||!1);return O.jsx("div",{id:"proxy-renderer","data-testid":"proxy-renderer",ref:u,children:O.jsx(LP,{state:s,documents:n,documentLoading:i,config:o,currentDocument:r,fileName:h,CurrentRenderer:e,t:c})})},IP=bt.div`
  display: flex;
  flex: 1;
  height: 75px;
  align-items: center;
...
`,cv={primary:"#fff",secondary:"#000",tertiary:"#ffffff99",textPrimary:"#000",textSecondary:"#fff",textTertiary:"#00000044",disableThemeScrollbar:!1},Ui=({mainState:{currentDocument:s},children:t,...e})=>s?O.jsx(OP,{id:"image-renderer",...e,children:t||O.jsx(NP,{id:"image-img",src:s.fileData})}):null;Ui.fileTypes=[];Ui.weight=0;const OP=bt.div`
  display: flex;
  flex: 1;
  align-items: center;
  justify-content: center;
...
`,NP=bt.img`
  max-width: 95%;
  max-height: 95%;
`,np=s=>O.jsx(Ui,{...s});np.fileTypes=["bmp","image/bmp"];np.weight=0;const Vh=({mainState:{currentDocument:s}})=>(U.useEffect(()=>{const t=s==null?void 0:s.fileData;let e="";const n=t==null?void 0:t.replace(/^data:text\/html;(?:charset=([^;]*);)?base64,/,(u,h)=>(e=h||"utf-8",""));let i=window.atob(n);const r=Uint8Array.from(i,u=>u.charCodeAt(0));i=new TextDecoder(e).decode(r);const o=document.getElementById("html-body"),l=(o==null?void 0:o.contentWindow)&&o.contentWindow;if(!l)return;const c=l.document;c.open(),c.write(`${i}`),c.close()},[s]),O.jsx(BP,{id:"html-renderer",children:O.jsx($P,{id:"html-body",sandbox:"allow-same-origin"})}));Vh.fileTypes=["htm","html","text/htm","text/html"];Vh.weight=0;Vh.fileLoader=r0;const BP=bt.div`
  display: flex;
...
`,p2=()=>{const{t:s}=eo(),{state:{mainState:t,paginated:e,zoomLevel:n,numPages:i,zoomJump:r,defaultZoomLevel:o},dispatch:l}=U.useContext(qa),c=(t==null?void 0:t.currentDocument)||null;return O.jsxs(g2,{id:"pdf-controls",children:[e&&i>1&&O.jsx(h2,{}),(c==null?void 0:c.fileData)&&O.jsx(m2,{id:"pdf-download",href:c==null?void 0:c.fileData,download:(c==null?void 0:c.fileName)||(c==null?void 0:c.uri),title:s("downloadButtonLabel"),children:O.jsx(r2,{color:"#000",size:"75%"})}),O.jsx(pu,{id:"pdf-zoom-out",onMouseDown:()=>l(eg(n-r)),children:O.jsx(a2,{color:"#000",size:"80%"})}),O.jsx(pu,{id:"pdf-zoom-in",onMouseDown:()=>l(eg(n+r)),children:O.jsx(o2,{color:"#000",size:"80%"})}),O.jsx(pu,{id:"pdf-zoom-reset",onMouseDown:()=>l(eg(o)),disabled:n===o,children:O.jsx(l2,{color:"#000",size:"70%"})}),i>1&&O.jsx(pu,{id:"pdf-toggle-pagination",onMouseDown:()=>l(YI(!e)),children:O.jsx(c2,{color:"#000",size:"70%",reverse:e})})]})},g2=bt.div`
  display: flex;
  position: sticky;
  top: 0;
  left: 0;
...
`;y0.workerSrc=new URL(`https://unpkg.com/pdfjs-dist@${r1}/build/pdf.worker.min.mjs`).toString();const wp=({mainState:s})=>O.jsx(ZI,{mainState:s,children:O.jsxs(v2,{id:"pdf-renderer","data-testid":"pdf-renderer",children:[O.jsx(p2,{}),O.jsx(e2,{})]})});wp.fileTypes=["pdf","application/pdf"];wp.weight=0;const v2=bt.div`
  display: flex;
  flex-direction: column;
  flex: 1;
...
`,Ep=s=>O.jsx(Ui,{...s});Ep.fileTypes=["gif","image/gif"];Ep.weight=0;const _p=({mainState:{currentDocument:s}})=>s?O.jsx(F2,{id:"video-renderer",children:O.jsx(M2,{controls:!0,src:s.uri})}):null;_p.fileTypes=["video/mp4","video/quicktime","video/x-msvideo"];_p.weight=0;const F2=bt.div`
  width: 100%;
`,M2=bt.video`
  width: 100%;
  height: 100%;
  border: 0;
`,xp=s=>O.jsx(Ui,{...s});xp.fileTypes=["webp","image/webp"];xp.weight=0;const L1=[np,Vh,ip,Wh,wp,Ap,Jh,Qh,tu,Ep,_p,xp],D2=U.forwardRef((s,t)=>{const{documents:e,theme:n}=s;if(!e)throw new Error("Please provide an array of documents to DocViewer!");return O.jsx(KT,{ref:t,pluginRenderers:L1,...s,children:O.jsx(xS,{theme:n?{...cv,...n}:cv,children:O.jsxs(N2,{id:"react-doc-viewer","data-testid":"react-doc-viewer",className:s.className,style:s.style,children:[O.jsx(xP,{}),O.jsx(kP,{})]})})})}),O2=U.memo(D2),N2=bt.div`
  display: flex;
  flex-direction: column;
  background: #ffffff;
  width: 100%;
  height: 100%;
`;exports.BMPRenderer=np;exports.Buffer=ed;exports.CSVRenderer=tu;exports.DocViewer=O2;exports.DocViewerRenderers=L1;exports.HTMLRenderer=Vh;exports.JPGRenderer=ip;exports.JPGRenderer$1=Ep;exports.MSDocRenderer=Wh;exports.PDFRenderer=wp;exports.PNGRenderer=Ap;exports.TIFFRenderer=Jh;exports.TXTRenderer=Qh;exports.VideoRenderer=_p;exports.WebPRenderer=xp;exports.arrayBufferFileLoader=rb;exports.binaryStringFileLoader=CP;exports.commonjsGlobal=go;exports.dataURLFileLoader=r0;exports.defaultFileLoader=ob;exports.dist=fR;exports.getAugmentedNamespace=F1;exports.getDefaultExportFromCjs=Um;exports.process$1=ct;exports.supportedLanguages=VT;exports.textFileLoader=o0;
